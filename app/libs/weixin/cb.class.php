...
class wechatCallbackapiTest
{
    ...
    private function receiveText($object)
    {
        ...
        if (strstr($keyword, "文本")){
            $content = '<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx8a1874c6220e55ea&redirect_uri='.urlencode("http://laravel.ana51.com/oauth").'&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect">测试网页授权</a>';
